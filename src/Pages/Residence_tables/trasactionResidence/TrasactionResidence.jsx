...
import TrasactionResidenceData from './TrasactionResidenceData.json'
...
const TrasactionResidence = () => {
  ...
  const datatableUsers = TrasactionResidenceData;
    ...
    return (
      <TableFrame>
        <div>
          ...
          <Pagination
            key={TrasactionResidenceData.id}
...
export default TrasactionResidence;
