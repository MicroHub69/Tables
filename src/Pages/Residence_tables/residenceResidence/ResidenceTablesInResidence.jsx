...
function ActivityResidence() {
  const [events, setEvents] = useState(ResidenceDataInResidence.slice(0, 20));
  ...
  const filterEvents = (catItem) => {
    const result = ResidenceDataInResidence.filter((curDate) => {
        ...
        <tr>
          <td>
            <div className="img-avatar">
              <div className="user-name">{first_name}</div>
            </div>
          </td>
          ...
          <td>
            <div className="date-time">{email}</div>
          </td>
          ...
          <td>
            <div className="transaction-purpose">{ranking}</div>
          </td>

          <td>
            <div className="date-time">{activate}</div>
          </td>

          <td>
            <div className="date-time">{deactivate}</div>
          </td>
        </tr>
      );
    });
            ...
            <div className="event-container">
              <HandleSearchAndTab>
                <div className="tabs">
                  ...
                  >
                    <button
                      onClick={(e) => setEvents(ResidenceDataInResidence)}
                    >
                      All
                    </button>
                  </span>
